    ...
    public static class IngredientSeed
    {
        public static void Ingredients(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Ingredient>().HasData(
              ...
              new Ingredient { Id = 8, Name = "Tomato", PurchaseUnitMeasure = UnitMeasureEnum.kg, PurchaseQuantity = 5, PurchasePrice = 10, CreatedDate = DateTime.Now },
              new Ingredient { Id = 9, Name = "Peppers", PurchaseUnitMeasure = UnitMeasureEnum.kg, PurchaseQuantity = 5, PurchasePrice = 15, CreatedDate = DateTime.Now },
              new Ingredient { Id = 10, Name = "Mushrooms", PurchaseUnitMeasure = UnitMeasureEnum.g, PurchaseQuantity = 20, PurchasePrice = 25, CreatedDate = DateTime.Now }
         );
        }
    }
}
